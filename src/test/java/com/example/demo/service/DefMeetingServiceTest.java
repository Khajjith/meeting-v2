...
public class DefMeetingServiceTest {
    ...
    private static final Meeting meeting = new Meeting(Meet_ID, LocalDate.of(2023,03,02), ules_type.rendkivuli, ules_jellege.nyilt, LocalTime.of(11,21,0,2));

    @Mock
    private MRepository mettingRepo;
